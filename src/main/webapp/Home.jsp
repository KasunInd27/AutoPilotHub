    ...
    <div class="container mx-auto px-4 py-20 md:py-32 relative z-10">
      <div class="max-w-3xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
          <a href="#services" class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-md text-lg font-medium text-center">Explore Services</a>
          <a href="Signin.jsp" class="border-2 border-white hover:bg-white hover:text-slate-900 text-white px-6 py-3 rounded-md text-lg font-medium text-center">Make Reservation</a>
        </div>
      </div>
    </div>
  </section>
